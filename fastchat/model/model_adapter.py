...
class LongChatAdapter(BaseModelAdapter):
    ...
    def load_model(self, model_path: str, from_pretrained_kwargs: dict):
        ...
        replace_llama_with_condense(config.rope_scaling.get("factor", 1))
...
class QwenChatAdapter(BaseModelAdapter):
    ...
    def load_model(self, model_path: str, from_pretrained_kwargs: dict):
        ...
        # FIXME: Adapt for qwen2.
        if generation_config.pad_token_id is None:
            print('generation_config does not have pad_token_id, set it to eos_token_id.')
            generation_config.pad_token_id = config.eos_token_id
